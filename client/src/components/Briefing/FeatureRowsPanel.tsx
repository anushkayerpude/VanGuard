...
export const FeatureRowsPanel: React.FC = () => {
  ...
  return (
    <div className="flex flex-col justify-center my-auto w-full max-w-xl mx-auto gap-6 sm:gap-7 overflow-hidden transition-all duration-300">
      {/* ========================================================================= */}
      {/* FEATURE ROW 1: AI SITREP // OPERATIONAL INTELLIGENCE (LIGHTER DEFENSE GLASS) */}
      {/* ========================================================================= */}
      <div
        className={`flex flex-col rounded-2xl border transition-all duration-300 overflow-hidden shadow-[0_12px_36px_rgba(0,0,0,0.35)] backdrop-blur-xl ${
          activeFeature === 'sitrep'
            ? 'bg-[#16273f]/92 border-cyan-400/85 shadow-[0_0_28px_rgba(0,240,255,0.22)] max-h-[46vh] min-h-[200px]'
            : 'bg-[#132238]/85 border-slate-500/60 hover:border-cyan-400/70 hover:bg-[#192c46]/90 cursor-pointer shrink-0'
        }`}
      >
        {/* Clickable Header Bar */}
        <div
          onClick={() => toggleFeature('sitrep')}
          className="px-5 py-4 flex items-center justify-between cursor-pointer select-none bg-gradient-to-r from-[#182a44]/95 via-[#223859]/90 to-[#182a44]/95 border-b border-slate-500/50 hover:from-[#1e3454] transition"
        >
          <div className="flex items-center space-x-3.5">
            <div
              className={`p-2.5 rounded-xl transition shadow-md ${
                activeFeature === 'sitrep'
                  ? 'bg-gradient-to-tr from-cyan-400 to-sky-500 text-slate-950 shadow-[0_0_12px_rgba(0,240,255,0.45)]'
                  : 'bg-[#101e30] border border-cyan-400/50 text-cyan-300'
              }`}
            >
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-[10px] text-emerald-300 font-bold bg-emerald-950/85 px-2.5 py-0.5 rounded-full border border-emerald-400/60 shadow-[0_0_8px_rgba(52,211,153,0.3)]">
                  100% CITED
                </span>
              </div>
          ...
          <div className="flex items-center space-x-3">
            <div
              className={`p-1.5 rounded-xl transition ${
                activeFeature === 'sitrep'
                  ? 'bg-[#101e30] text-cyan-300 border border-cyan-400/50'
                  : 'bg-[#101e30]/80 text-slate-200 hover:text-white'
              }`}
            >
              {activeFeature === 'sitrep' ? (
        ...
        {activeFeature === 'sitrep' && (
          <div className="flex-1 overflow-y-auto p-4 space-y-3.5 custom-scrollbar">
            {/* Headline Card */}
            <div className="p-3.5 bg-gradient-to-r from-cyan-950/70 via-[#1b2f4a]/95 to-[#16273f] border-l-4 border-cyan-400 rounded-r-xl rounded-l-md shadow-md flex items-center justify-between gap-2">
            ...
            <div className="bg-[#1b2f4a]/90 border border-slate-500/50 rounded-xl p-3.5 shadow-sm">
            ...
            <div className="bg-[#1b2f4a]/90 border border-slate-500/50 rounded-xl p-3.5 shadow-sm space-y-2.5">
                        ...
                        <button
                          ...
                          className={`px-2.5 py-0.5 rounded-lg text-[10px] font-mono font-bold uppercase transition flex items-center space-x-1 cursor-pointer ${
                            selectedEventId === eid
                              ...
                              : 'bg-slate-900/90 hover:bg-slate-800 border border-slate-500/60 text-cyan-300'
                          }`}
                        >
                          <span>#{eid}</span>
            ...
            <div className="bg-[#1b2f4a]/90 border border-slate-500/50 rounded-xl p-3.5 shadow-sm relative overflow-hidden space-y-2.5">
              ...
              <div className="space-y-2 z-10 relative">
                {aiBriefing.prioritizedActions.map((act) => (
                  <div
                    key={act.actionId}
                    className="p-3 bg-[#203654]/90 border border-slate-500/50 rounded-xl flex items-start space-x-3"
                  >
                    <span
      ...
      {/* ========================================================================= */}
      {/* FEATURE ROW 2: LIVE MULTI-SOURCE FEED (LIGHTER DEFENSE GLASS) */}
      {/* ========================================================================= */}
      <div
        className={`flex flex-col rounded-2xl border transition-all duration-300 overflow-hidden shadow-[0_12px_36px_rgba(0,0,0,0.35)] backdrop-blur-xl ${
          activeFeature === 'feed'
      ...
      >
          ...
          <div className="flex items-center space-x-3.5">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-[10px] text-cyan-300 font-bold bg-cyan-950/85 px-2.5 py-0.5 rounded-full border border-cyan-400/60 font-mono shadow-[0_0_8px_rgba(0,240,255,0.25)]">
        ...
        {activeFeature === 'feed' && (
          <div className="flex-1 flex flex-col overflow-hidden">
            {/* Filter search bar */}
            <div className="p-3.5 bg-[#101c2e]/95 border-b border-slate-500/50">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3.5 py-2 bg-[#1b2f4a] border border-slate-500/60 rounded-xl text-xs text-white placeholder-slate-300 focus:outline-none focus:border-cyan-400"
                />
              </div>
            </div>
                ...
                return (
                  <div
                    ...
                    className={`p-3 rounded-xl border transition cursor-pointer ${
                      isSelected
                        ? 'bg-[#243d60] border-cyan-400 shadow-[0_0_16px_rgba(0,240,255,0.35)]'
                        : 'bg-[#182b45]/90 hover:bg-[#203656] border-slate-500/50'
                    }`}
                  >
                    ...
                    <div className="flex items-center justify-between mt-2 pt-1.5 border-t border-slate-500/50 text-[10px] font-mono text-slate-300">
                      <span>
      ...
      {/* ========================================================================= */}
      {/* FEATURE ROW 3: FEED ADAPTER PIPELINES (LIGHTER DEFENSE GLASS) */}
      {/* ========================================================================= */}
      <div
        className={`flex flex-col rounded-2xl border transition-all duration-300 overflow-hidden shadow-[0_12px_36px_rgba(0,0,0,0.35)] backdrop-blur-xl ${
          ...
          <div className="flex items-center space-x-3.5">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-[10px] text-emerald-300 font-bold bg-emerald-950/85 px-2.5 py-0.5 rounded-full border border-emerald-400/60 flex items-center space-x-1.5 font-mono shadow-[0_0_8px_rgba(52,211,153,0.3)]">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar">
            ...
            <div className="space-y-2.5">
              {sourceHealth.map((sh) => (
                <div
                  key={sh.sourceType}
                  className="p-3.5 bg-[#182b45]/90 border border-slate-500/50 rounded-xl flex items-center justify-between shadow-sm hover:border-cyan-400/60 transition"
                >
                  <div className="flex items-center space-x-3.5">
                    <div className="p-2 bg-[#101e30] rounded-xl border border-slate-500/60">
